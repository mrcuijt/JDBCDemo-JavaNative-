package com.promeritage.jdbc.test;
...
public class PromeritagJdbcTest {
	...
	public void testMain() {
		...
		try {
			connection = 
					DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/USER?useUnicode=yes&characterEncoding=UTF-8", info);
